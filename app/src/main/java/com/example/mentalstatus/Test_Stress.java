...
public class Test_Stress extends AppCompatActivity {

    private final List<QuestionList_Stress> stressQuestionList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Agreement_Dialog agreementDialog = new Agreement_Dialog(Test_Stress.this);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot questions : snapshot.child("stressOption").getChildren()){
                    ...
                    QuestionList_Stress questionList_stress = new QuestionList_Stress(getQuestion, getOption1, getOption2, getOption3, getOption4, getEquivalent);

                    //Adding depressionquestionlist object into list
                    stressQuestionList.add(questionList_stress);
                }

                //Setting total questions to Text View
                totalQuestionTV.setText("/"+ stressQuestionList.size());
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Test_Stress.this, "Failed to get data from database", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(selectedOption != 0){
                    ...
                    stressQuestionList.get(currentQuestionPosition).setAnswerEquivalent(scoreEquivalent);
                    ...
                    if(currentQuestionPosition< stressQuestionList.size()){
                    ...
                    Toast.makeText(Test_Stress.this, "Please select an Option", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void finishQuiz(){
        ...
        Intent intent = new Intent(Test_Stress.this, QuizResult_Stress.class);

        //Bundle to pass QuestionList
        Bundle bundle = new Bundle();
        bundle.putSerializable("stressOption", (Serializable) stressQuestionList);
    ...
    private void selectQuestion(int questionListPosition){
        ...
        questionTV.setText(stressQuestionList.get(questionListPosition).getQuestion());
        option1TV.setText(stressQuestionList.get(questionListPosition).getOption1());
        option2TV.setText(stressQuestionList.get(questionListPosition).getOption2());
        option3TV.setText(stressQuestionList.get(questionListPosition).getOption3());
        option4TV.setText(stressQuestionList.get(questionListPosition).getOption4());
