...
public class QuestionList_Depression implements Serializable {
    ...
    public QuestionList_Depression(String question, String option1, String option2, String option3, String option4, int equivalent) {
