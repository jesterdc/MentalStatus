...
public class Test_Depression extends AppCompatActivity {

    private final List<QuestionList_Depression> depressionquestionListDepressions = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Agreement_Dialog agreementDialog = new Agreement_Dialog(Test_Depression.this);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot questions : snapshot.child("questions").getChildren()){
                    ...
                    QuestionList_Depression questionListDepression = new QuestionList_Depression(getQuestion, getOption1, getOption2, getOption3, getOption4, getEquivalent);

                    //Adding depressionquestionlist object into list
                    depressionquestionListDepressions.add(questionListDepression);
                }

                //Setting total questions to Text View
                totalQuestionTV.setText("/"+ depressionquestionListDepressions.size());
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Test_Depression.this, "Failed to get data from database", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(selectedOption != 0){
                    ...
                    depressionquestionListDepressions.get(currentQuestionPosition).setAnswerEquivalent(scoreEquivalent);
                    ...
                    if(currentQuestionPosition< depressionquestionListDepressions.size()){
                    ...
                    Toast.makeText(Test_Depression.this, "Please select an Option", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void finishQuiz(){
        ...
        Intent intent = new Intent(Test_Depression.this, QuizResult_Depression.class);

        //Bundle to pass QuestionList
        Bundle bundle = new Bundle();
        bundle.putSerializable("questions", (Serializable) depressionquestionListDepressions);
    ...
    private void selectQuestion(int questionListPosition){
        ...
        questionTV.setText(depressionquestionListDepressions.get(questionListPosition).getQuestion());
        option1TV.setText(depressionquestionListDepressions.get(questionListPosition).getOption1());
        option2TV.setText(depressionquestionListDepressions.get(questionListPosition).getOption2());
        option3TV.setText(depressionquestionListDepressions.get(questionListPosition).getOption3());
        option4TV.setText(depressionquestionListDepressions.get(questionListPosition).getOption4());
