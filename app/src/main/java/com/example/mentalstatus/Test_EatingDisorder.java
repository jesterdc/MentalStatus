...
public class Test_EatingDisorder extends AppCompatActivity {

    private final List<QuestionList_EatingDisorder> eatingDisorderQuestionList= new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eating_disorder_test);
        ...
        Agreement_Dialog agreementDialog = new Agreement_Dialog(Test_EatingDisorder.this);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot questions : snapshot.child("eatingDisorderOption").getChildren()){
                    ...
                    QuestionList_EatingDisorder eatingDisorder = new QuestionList_EatingDisorder(getQuestion, getOption1, getOption2, getOption3, getOption4, getEquivalent);

                    //Adding depressionquestionlist object into list
                    eatingDisorderQuestionList.add(eatingDisorder);
                }

                //Setting total questions to Text View
                totalQuestionTV.setText("/"+ eatingDisorderQuestionList.size());
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Test_EatingDisorder.this, "Failed to get data from database", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(selectedOption != 0){
                    ...
                    eatingDisorderQuestionList.get(currentQuestionPosition).setAnswerEquivalent(scoreEquivalent);
                    ...
                    if(currentQuestionPosition< eatingDisorderQuestionList.size()){
                    ...
                    Toast.makeText(Test_EatingDisorder.this, "Please select an Option", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void finishQuiz(){
        ...
        Intent intent = new Intent(Test_EatingDisorder.this, QuizResult_EatingDisorder.class);

        //Bundle to pass QuestionList
        Bundle bundle = new Bundle();
        bundle.putSerializable("eatingDisorderOption", (Serializable) eatingDisorderQuestionList);
    ...
    private void selectQuestion(int questionListPosition){
        ...
        questionTV.setText(eatingDisorderQuestionList.get(questionListPosition).getQuestion());
        option1TV.setText(eatingDisorderQuestionList.get(questionListPosition).getOption1());
        option2TV.setText(eatingDisorderQuestionList.get(questionListPosition).getOption2());
        option3TV.setText(eatingDisorderQuestionList.get(questionListPosition).getOption3());
        option4TV.setText(eatingDisorderQuestionList.get(questionListPosition).getOption4());
