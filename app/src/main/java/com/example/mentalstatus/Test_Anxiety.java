...
public class Test_Anxiety extends AppCompatActivity {

    private final List<QuestionList_Anxiety> anxietyquestionLists = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Agreement_Dialog agreementDialog = new Agreement_Dialog(Test_Anxiety.this);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot questions : snapshot.child("anxietyOption").getChildren()){
                    ...
                    QuestionList_Anxiety anxietyQuestionList = new QuestionList_Anxiety(getQuestion, getOption1, getOption2, getOption3, getOption4, getEquivalent);

                    //Adding depressionquestionlist object into list
                    anxietyquestionLists.add(anxietyQuestionList);
                }

                //Setting total questions to Text View
                totalQuestionTV.setText("/"+anxietyquestionLists.size());
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Test_Anxiety.this, "Failed to get data from database", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(selectedOption != 0){
                    ...
                    anxietyquestionLists.get(currentQuestionPosition).setAnswerEquivalent(scoreEquivalent);
                    ...
                    if(currentQuestionPosition<anxietyquestionLists.size()){
                    ...
                    Toast.makeText(Test_Anxiety.this, "Please select an Option", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void finishQuiz(){
        ...
        Intent intent = new Intent(Test_Anxiety.this, QuizResult_Anxiety.class);

        //Bundle to pass QuestionList
        Bundle bundle = new Bundle();
        bundle.putSerializable("anxietyOption", (Serializable) anxietyquestionLists);
    ...
    private void selectQuestion(int questionListPosition){
        ...
        questionTV.setText(anxietyquestionLists.get(questionListPosition).getQuestion());
        option1TV.setText(anxietyquestionLists.get(questionListPosition).getOption1());
        option2TV.setText(anxietyquestionLists.get(questionListPosition).getOption2());
        option3TV.setText(anxietyquestionLists.get(questionListPosition).getOption3());
        option4TV.setText(anxietyquestionLists.get(questionListPosition).getOption4());
